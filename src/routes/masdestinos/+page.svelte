<script lang="ts">
    ...
    // Props en Svelte 5 (runes)
    let { data } = $props<PageData>();

    // Datos provenientes del load
    let pais = data.pais;
    let page = data.page;
        ...
        {#each deals as deal}
            ...
            >
                ...
                <div class="relative h-56 overflow-hidden bg-gray-100 flex-shrink-0">
                    ...
                    <button
                        type="button"
                        onclick={(e) => { e.stopPropagation(); reportarCambioPrecio(deal.id, e); }}
                ...
                <div class="p-6 flex flex-col flex-grow bg-white relative">
                    ...
                    <div class="mt-auto pt-5 border-t border-gray-100 flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button
                                type="button"
                                onclick={(e) => { e.stopPropagation(); copiarUrlUnica(deal.id, e); }}
                                title="Copiar enlace"
