<script lang="ts">
    ...
    // Runes props (Svelte 5): propiedades, no export let
...
>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-12 flex-1">
        ...
        <!-- Radar, modal, paginación y footer siguen igual que la versión anterior,
             solo cambiando on:click / on:submit por onclick / onsubmit de forma consistente. -->
    </main>
</div>
