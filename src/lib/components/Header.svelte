  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
    ...
    <div class="flex items-center gap-4">
      ...
      <div id="selector-pais" class="relative inline-block text-left">
        ...
        {#if dropdownAbierto}
          <div
            class="origin-top-right absolute right-0 mt-2 w-48 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 z-50 overflow-hidden border border-gray-100 animate-fadeIn"
            role="menu"
          >
            <div class="py-1">
              {#each paises as p}
                <button
                  type="button"
                  onclick={() => seleccionarPais(p.codigo)}
